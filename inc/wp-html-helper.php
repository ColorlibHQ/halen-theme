...
// image default alt
if ( ! function_exists( 'halen_img_default_alt' ) ) {
	function halen_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'halen_img_tag' ) ) {
	function halen_img_tag( array $args ) {
...
// Anchor Tag
if ( ! function_exists( 'halen_anchor_tag' ) ) {
	function halen_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'halen_heading_tag' ) ) {
	function halen_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'halen_paragraph_tag' ) ) {
	function halen_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'halen_other_tag' ) ) {
	function halen_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'halen_button_element ' ) ) {
	function halen_button_element( array $args ) {
