...
// enqueue css
function halen_common_custom_css(){
    
    wp_enqueue_style( 'halen-common', get_template_directory_uri().'/assets/css/common.css' );

		$whiteColor     		  	= '#ffffff';
		$themeColor     		  	= halen_opt( 'halen_theme_color' ) != '#131313' ? halen_opt( 'halen_theme_color' ) : '';
		$themeSecColor     		  	= '';
		$bookBtnColor       		= halen_opt( 'halen_book_btn_color' ) != '#131313' ? halen_opt('halen_book_btn_color') : '';
		$bookBtnHoverBgColor     	= halen_opt( 'halen_book_btn_hvr_bg_color' ) != '#131313' ? halen_opt('halen_book_btn_hvr_bg_color') : $themeColor;
		$hoverColor     	  	  = halen_opt( 'halen_quote_btn_hvr_text_color');

		$headerTop_bg     		  = '';
		$navbarBgColor     		  = halen_opt( 'halen_navbar_bg_color' ) != '#082b49' ? halen_opt( 'halen_navbar_bg_color') : '';
		$headerTop_col     		  = halen_opt( 'halen_top_header_color' );

		$headerTopBg      		  = halen_opt( 'halen_top_header_bg_color');
		$headerBg          		  = halen_opt( 'halen_header_bg_color') != '#ffffff' ? halen_opt( 'halen_header_bg_color') : '';
		$menuColor          	  = halen_opt( 'halen_header_menu_color' ) != '#131313' ? halen_opt('halen_header_menu_color') : '';
		$menuHoverColor           = halen_opt( 'halen_header_menu_hover_color' ) != '#808080' ? halen_opt('halen_header_menu_hover_color') : $themeColor;
		$menuFixedHoverColor      = halen_opt( 'halen_header_menu_fixed_hover_color' );
		$dropMenuBgColor          = halen_opt( 'halen_header_drop_menu_bg_color' ) != '#ffffff' ? halen_opt('halen_header_drop_menu_bg_color') : $themeColor;
		$dropMenuColor            = halen_opt( 'halen_dropdown_menu_color' ) != '#131313' ? halen_opt('halen_dropdown_menu_color') : '';
		$dropMenuHovColor         = halen_opt( 'halen_dropdown_menu_hover_color' ) != '#808080' ? halen_opt('halen_dropdown_menu_hover_color') : $themeColor;

		$footerwbgColor     	  = halen_opt( 'halen_footer_widget_bg_color' );
		$footerwHeadColor   	  = halen_opt('halen_footer_widget_heading_color');
		$footerwTextColor   	  = halen_opt('halen_footer_widget_text_color');
		$footerwanchorcolor 	  = halen_opt('halen_footer_widget_anchor_color') != '#ffffff' ? halen_opt('halen_footer_widget_anchor_color') : '';
		$footerwanchorhovcolor    = halen_opt('halen_footer_widget_anchor_hover_color') != '#ffffff' ? halen_opt('halen_footer_widget_anchor_hover_color') : '';
		
		$fofbg					  = halen_opt('halen_fof_bg_color');
		$foftonecolor			  = halen_opt('halen_fof_textone_color');
		$fofttwocolor			  = halen_opt('halen_fof_texttwo_color');

		$bannerBtnHeaderSpanColor = $themeColor != '#ff5e13' ? $themeColor : '';
		$footerAncDefColor 		  = halen_opt('halen_footer_widget_anchor_color') != '#9e9e9e' ? halen_opt('halen_footer_widget_anchor_color') : '';
		...
		$customcss ="			
			...
			.footer-area .single-footer-widget .btn, .footer .footer_top .footer_widget .halen_mailchimp_newsletter_widget button, .footer .footer_top .footer_widget .halen_mailchimp_newsletter_widget button
			{
    ...
    wp_add_inline_style( 'halen-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'halen_common_custom_css', 50 );