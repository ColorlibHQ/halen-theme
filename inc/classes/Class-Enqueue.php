 ...
 */
	...
	class halen_Enqueue{
		...
		public function halen_scripts_enqueue_init(){
			add_action( 'wp_enqueue_scripts', array( $this, 'halen_frontend_enqueue_scripts', ) );
		}

		public function halen_frontend_enqueue_scripts( ){
