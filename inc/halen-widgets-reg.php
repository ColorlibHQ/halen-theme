...
function halen_widgets_init() {
    // sidebar widgets register
    register_sidebar( array(
        'name'          => esc_html__( 'Sidebar', 'halen' ),
        'id'            => 'halen-post-sidebar',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Two', 'halen' ),
        'id'            => 'footer-2',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Three', 'halen' ),
        'id'            => 'footer-3',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Four', 'halen' ),
        'id'            => 'footer-4',
...
add_action( 'widgets_init', 'halen_widgets_init' );
